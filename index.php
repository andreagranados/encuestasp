...
<body>
                ...
                <div class="menu-holder">
                    <div class="col-md-3 col-sm-2 logo">
                       <a href="#" title="templatemo 420 ocean">
                            <img src="images/logo_institucion.png" width="150" height="150" alt="encuestas">
    ...
    <div class="content-section" id="products">
        ...
        <div class="container">
             <img src="images/spdi.png" alt="">
            <p style="border-radius: 1em; padding: 10px; COLOR: #000000;  font-family: arial,helvetica; font-size: 26px; font-weight: bold;text-align: center;">&#161;Nos interesa tu opini&oacute;n!</p>
            <div class="row">
                <div class="col-md-6">
                    <p style="border: 2px solid #3e9efe;border-radius: 1em; padding: 10px; COLOR: #FFFFFF; BACKGROUND-COLOR: #253552; font-family: arial,helvetica; font-size: 14px; font-weight: bold;">LA ENCUESTA ES AN&#211;NIMA. <br> Solicitamos su DNI al inicio, &uacute;nicamente para asegurarnos que pertenece a la Universidad.</p>
                    <p style="border: 2px solid #3e9efe;border-radius: 1em; padding: 10px; COLOR: #FFFFFF; BACKGROUND-COLOR: #22A9A9; font-family: arial,helvetica; font-size: 14px; font-weight: bold;">LA ENCUESTA PUEDE REALIZARSE S&#211;LO UNA VEZ. Es decir, no puede interrumpirse y retomarse en otro momento. Una vez que accede al cuestionario, no podr&aacute; volver a responderlo. </p>
                    <p style="border: 2px solid #3e9efe;border-radius: 1em; padding: 10px; COLOR: #FFFFFF; BACKGROUND-COLOR: #EA841C; font-family: arial,helvetica; font-size: 14px; font-weight: bold;">LE TOMAR&#193 SOLAMENTE ALGUNOS MINUTOS RESPONDERLA.<br>Lea detenidamente las preguntas y las opciones antes de responder.</p>
                    <p style="border: 2px solid #3e9efe;border-radius: 1em; padding: 10px; COLOR: #FFFFFF; BACKGROUND-COLOR: #D90C59; font-family: arial,helvetica; font-size: 14px; font-weight: bold;">Toda la informaci&oacute;n consignada aqu&iacute; ser&aacute; muy importante para el Plan de Desarrollo Institucional de nuestra Universidad.</p>
...
Toda la informaci&oacute;n consignada aqu&iacute; ser&aacute; un insumo muy importante para el Plan de Desarrollo Institucional.</h3>-->
                ...
                <div class="col-md-6">
                    <div class="product-content col-md-7 col-xs-12 ">
                        ...
                        <form name="form1" method ="post" action="login_ac.php" class="login">
    				<h1>Encuestas</h1>
